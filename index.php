...
<body>
	<div class="preloader">
		<img src="img/google_ventures_logo.png" alt="Preloader image">
	...
	<nav class="navbar">
		<div class="container">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#"><img src="img/logo.png" data-active-url="img/logo-active.png" alt=""></a><!-- BP button -->
			</div>
				...
				<div class="header-text">
					<div class="row">
						<div class="col-md-12 text-center">
							<h3 class="light white" style="color: #0c6208">WELCOME TO THE SRI LANKA!</h3>
							<h1 class="white typed" style="color: #06ff00">This is the most beautiful country, you naver seen before.</h1>
	...
	<div class="modal fade" id="modal1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content modal-popup">
				...
				<form class="popup-form" name="myForm" action="" onsubmit="return validateForm();" method="post">
					<input type="text" class="form-control form-white" placeholder="First Name">
