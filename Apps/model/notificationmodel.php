...
function addNoticationUser($not_id,$user_id,$cus_id,$nu_status,$nu_error) {
       
        global $con;


        $r=$con->prepare("INSERT INTO notification_user (not_id,user_id,cus_id,nu_status,nu_error) "
                . "VALUES(?,?,?,?,?)");
        $r->execute(array($not_id,$user_id,$cus_id,$nu_status,$nu_error));
