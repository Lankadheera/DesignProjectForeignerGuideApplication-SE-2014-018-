...
if(isset($_POST['se'])){
    if($_POST['from'] != "" && $_POST['to'] != "") {
        $from = $_POST['from'];
        $to = $_POST['to'];
        $resultorder = $oborder->getOrderDetailsByDates($from, $to);
        $nor=$resultorder->rowCount();
    }else if($_POST['from']!="" && $_POST['to']==""){ //select only the date
        $from=$_POST['from'];
        $resultorder = $oborder->getOrderDetailsByDate($from);
        $nor=$resultorder->rowCount();
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-sm-6" style="text-align: right">
                        <ol class="breadcrumb">
                            ...
                            <li class="active">Order by Data Range Report</li>
                        </ol>
                    </div>
                </div>
            </div>
            <div id="contents">
                <div class="row">
                   <?php include '../common/modules.php'; ?>
                    ...
                    <div class="col-md-9 col-sm-8">Order by Data Range Report
                       
                            <div class="container-fluid">
                                <div class="row">
                                    <form action="orderdaterange.php" method="post">
                                    <div class="col-md-4">
                                        From :
                              ...
                              <?php while($roworder = $resultorder->fetch(PDO::FETCH_BOTH)) {?>          
                                        <tr>
                                            ...
                                            <td><?php echo $roworder['cus_fname']." ".$roworder['cus_lname']; ?></td>
